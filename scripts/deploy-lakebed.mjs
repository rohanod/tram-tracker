...
try {
  ...
  await Promise.all([
    writeFile(join(stage, "storage-data/transit-metadata.json"), '{"v":1,"generatedAt":"","stops":[],"lines":[]}'),
    writeFile(join(stage, "storage-data/transit-geometry.json"), '{"v":1,"precision":5,"features":[]}')
  ]);
